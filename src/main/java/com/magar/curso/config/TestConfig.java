package com.magar.curso.config;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//associando os produtos no fluxo grama 2
		...
		o1.setPayment(pay1); //associação do pedido o1
